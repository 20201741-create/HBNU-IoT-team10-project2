...
# Fed algorithm
# class CustomStrategy(fl.server.strategy.FedAdam):
# class CustomStrategy(fl.server.strategy.FedYogi):
# class CustomStrategy(fl.server.strategy.FedAdagrad):

# class CustomStrategy(fl.server.strategy.FedProx):
...
if __name__ == "__main__":
    ...
    # strategy = CustomStrategy(initial_parameters=initial_parameters, eta=0.01, tau=1e-3) # FedYogi
    # strategy = CustomStrategy(initial_parameters=initial_parameters, eta=0.1, tau=1e-3) # FedAdagrad
